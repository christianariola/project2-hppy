        ...
        <div className="survey" >
            ...
            >
                ...
                <div className="survey-question">
                    <label htmlFor="a1">Q1: Lorem ipsum dolor sit amet, consectetur ? 
                        <div className="answer">
                            <label>
                                <input type="radio" name="a1" value="Congue praesent ac odio"
                                onChange={(e) => setAnswer1(e.target.value)}/>Congue praesent ac odio
                            </label>
                            <label>
                                <input type="radio" name="a1" value="Congue praesent ac turo"
                                onChange={(e) => setAnswer1(e.target.value)}
                                />Congue praesent ac turo
                            </label>
                            <label>
                                <input type="radio" name="a1" value="Congue  ac odio grnds"
                ...
                <div className="survey-question">
                    ...
                    <div className="answer">
                        <label>
                            <input type="radio" name="a3" id="a3" value="Bibendum vivamus ut lacinia auctor"
                            onChange={(e) => setAnswer3(e.target.value)}/>Bibendum vivamus ut lacinia auctor
                        </label>
                       <label>
                            <input type="radio" name="a3" id="a3" value="Congue bibendum vivamu ac turo"
                                onChange={(e) => setAnswer3(e.target.value)} />Congue bibendum vivamu ac turo
                        </label>
                        <label>
                            <input type="radio" name="a3" id="a3" value="Ac odio bibendum"
                ...
                <div className="survey-question">
                    ...
                    <div className="answer">
                        <select name="a4" onChange={(e) => setAnswer4(e.target.value)}>    
                            <option
