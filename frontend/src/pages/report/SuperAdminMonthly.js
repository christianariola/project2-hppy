...
const SuperAdminMonthly = (props) => {
  ...
  let getMonthlySurveySubmit = function () {
    ...
    for (let i = 0; i < showEmailArry.length; i++) {
      if (
        ...
        filteredMonthlySurvey[i].monthlyTotalRating != null
      ) {
    ...
    datasets: [
      {
        ...
        data: [
          monthlySubmissionResult.unsubmitted,
          monthlySubmissionResult.submitted,
        ],
  ...
  return (
    <div>
      <h1>
        {decodedCompany}'s Monthly Report - {chartDate}
      </h1>
