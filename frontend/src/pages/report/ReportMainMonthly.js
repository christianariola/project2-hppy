              ...
              {sortMonthlySurveyByCompany?.map((sortMonthlySurveyByCompany) => (
                <tr className="report-content" key={monthlyItem.surveyid}>
                  ...
                  <td>
                    <button
                      className="view-btn"
                      value={sortMonthlySurveyByCompany.surveyDate}
                    >
                      <Link
                        component={RouterLink}
                        to={`/app/reportchart/${sortMonthlySurveyByCompany.surveyTitle}/${sortMonthlySurveyByCompany.surveyDate}/${sortMonthlySurveyByCompany.companyName}`}
                        variant="button"
                        sx={{ my: 1, mx: 1.5 }}
                        underline="none"
                        color="inherit"
                ...
                <tr className="report-content" key={monthlyItem.surveyid}>
                  ...
                  <td>
                    <button
                      ...
                      data-value1="monthly"
                      onClick={(e) =>
                        props.handleSelectChartDate(e.target.value)
                      }
                    >
                      <Link
                        component={RouterLink}
                        to={`/app/reportchart/${sortMonthlySurvey.monthlysurveyTitle}/${sortMonthlySurvey.monthlysurveyDate}`}
                        variant="button"
                        sx={{ my: 1, mx: 1.5 }}
                        underline="none"
                        color="inherit"
